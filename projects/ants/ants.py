...
class FireAnt(Ant):
    ...
    # NOTES: does *amount* damage to surrounding bees when it receives *same amount* damage
    ...
    def reduce_health(self, amount):
        ...
        Make sure to reduce the health of each bee in the current place, and 
...
class ContainerAnt(Ant):
    ...
    # can CONTAIN and PROTECT another ant from ONE PLACE.
    # when STUNG, only CONTAINER is damaged. If CONTAINER gone, ant still remains in place but is now vulnerable
    # can_contains is True IF: current ant does not already have ant or other ant is not container
...
class SlowThrower(ThrowerAnt):
    ...
    def throw_at(self, target): # takes in target bee and "slows" it
        # BEGIN Problem 13
        if target is not None:
